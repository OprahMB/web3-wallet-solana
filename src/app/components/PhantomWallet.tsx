...
const useProps = (): Props => {
  ...
  const connection = new Connection('https://localhost:3000')
...
export default function App() {
  ...
  return (
    ...
    <button onClick={handleConnect} className="mt-4 cursor-pointer bg-[#AB9EF3] px-6 py-4 rounded-2xl hover:opacity-50">Please Connect Wallet</button>
    <div className="space-y-6">
          <h1>You connected as Solana Wallet <br /><b>{''}</b></h1> 
